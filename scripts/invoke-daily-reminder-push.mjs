#!/usr/bin/env node
/**
 * Invoke daily-reminder-push on the linked Supabase project.
 *
...
if (!cronSecret) {
  console.error(
    'Missing CRON_SECRET.\n\n' +
      ...
      '  4. Redeploy: npm run deploy:function:daily-reminder-push',
  )
  process.exit(1)
}
...
const functionUrl = `${projectBase}/functions/v1/daily-reminder-push`
