-- Expand realtime badge evaluation with additional daily/weekly milestones.
...
begin
  ...
  -- Daily/weekly volume milestones.
  ...
  if v_weekly_perfect_count >= 8 then
    insert into public.badges_awarded (user_id, badge_key, metadata)
      values (
        v_user,
        'weekly_eight',
